module Shared
  module ScatteredPositions
    ...
    def test_delete_middle
      ...
      assert_equal 8, ListMixin.find(3).pos
      assert_equal 11, ListMixin.find(4).pos

      ListMixin.find(1).destroy

      assert_equal [3, 4], ListMixin.find(:all, :conditions => 'parent_id = 5', :order => 'pos').map(&:id)

      assert_equal 7, ListMixin.find(3).pos
      assert_equal 10, ListMixin.find(4).pos
    end
    ...
    def test_before_destroy_callbacks_do_not_update_position_to_nil_before_deleting_the_record
      ...
      assert_equal 3, ListMixin.find(1).pos
      assert_equal 6, ListMixin.find(2).pos
      assert_equal 8, ListMixin.find(3).pos
      assert_equal 11, ListMixin.find(4).pos
    end
    ...
    def test_before_create_callback_adds_to_given_position
      ...
      assert_equal [5, 6, 1, 2, 3, 4], ListMixin.find(:all, :conditions => 'parent_id = 5', :order => 'pos').map(&:id)
    end
  end
end
